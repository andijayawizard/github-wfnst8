...
const { data: list, pending } = await useFetch(
  `${config.public.apiUrlAfl}/api/api.php/records/people?filter=pub,eq,1`,
  {
    headers: {
      ...
      <div class="container">
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div
            ...
            :key="index"
            class="w-full sm:w-1/2 lg:w-1/4 px-4"
          >
            <div class="mb-10 wow fadeInUp" data-wow-delay=".1s">
              ...
              >
                <img
                  :src="`${config.public.apiUrlAfl}/assets/uploads/images/people/${item.acak}-1.jpg`"
                  :alt="`${item.nama}`"
              ...
              <div class="text-center">
                <h4
                  class="font-medium text-lg text-dark mb-2"
                  v-text="item.nama"
                ></h4>
                <p
                  class="font-medium text-sm text-body-color mb-5"
                  v-text="item.rgks"
                ></p>
